...
Usage: import the module (see Jupyter notebooks for examples), or run from
	...
	#  python ./samples/CNNAbis_test_train.py train 
	 	 	  --dataset=/media/robot/Storage/images/NAIP_Imagery/2016_1024x_CNNabis 
	 	 	  --model=/media/robot/Storage/images/NAIP_Imagery/2016_1024x_CNNabis/logs/\
	 	 	  cnnabis_naip_201620190308T1302/mask_rcnn_cnnabis_naip_2016_0001.h5
"""
...
DEFAULT_LOGS_DIR = os.path.join('/media/robot/Storage/images/NAIP_Imagery/2016_1024x_CNNabis', "logs")
...
if __name__ == '__main__':
	...
	# use following line to train from coco weights file for a 4-band image
